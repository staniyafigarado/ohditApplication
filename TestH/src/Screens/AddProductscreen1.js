    ...
    render() {
        ...
        return (
            <LinearGradient
                ...
                <View style={{ backgroundColor: '#F1F1F1', flex: 1, borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20, alignItems: 'center', justifyContent: 'center' }}>
                    <Image source={line} style={{ width: 50, height: 5, bottom: 150 }}></Image>
                        ...
                        <Neomorph style={CommonStyles.customInputWrapper}>
                            <Neomorph
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ paddingVertical: 10, paddingHorizontal: 90 }}>
                                    <Text style={{ color: '#6834B4', fontFamily: 'Roboto-Medium', fontSize: 16 }}>View Products</Text>
                                </TouchableOpacity>
