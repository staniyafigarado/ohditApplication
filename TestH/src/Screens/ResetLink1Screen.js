            ...
            <LinearGradient
                ...
                <View style={{ padding: 20 }}>
                    <View style={CommonStyles.headerContainer}>
                        <TouchableOpacity style={{ alignSelf: 'flex-start', top: 7 }}>
                    ...
                    <View style={{ marginTop: 10 }}>
                        ...
                        <TouchableOpacity style={{ backgroundColor: '#F1F1F1', width: 144, height: 40, borderRadius: 20, justifyContent: 'center', marginTop: 15 }}>
